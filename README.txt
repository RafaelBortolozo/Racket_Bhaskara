Programa em Racket que realiza o calculo de Bhaskara, além disso, todos os dados do calculo são salvos em um arquivo.txt e num banco de dados (SQLite version 3)
